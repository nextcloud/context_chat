OC.L10N.register(
    ...
    "Nextcloud Assistant Context Chat Provider" : "Nextcloud Assistant Context Chat Poskytovateľ",
    "Nextcloud Assistant Context Chat Search Provider" : "Nextcloud Assistant Context Chat Poskytovateľ vyhľadávania",
    "Context Chat search" : "Context Chat vyhľadávanie",
    "Search with Context Chat." : "Vyhľadávanie s Context Chat.",
    "Prompt" : "Zadanie",
    "Search your documents, files and more" : "Vyhľadávajte vo svojich dokumentoch, súboroch a ďalších.",
    "Scope type" : "Typ rozsahu",
    "Scope list" : "Zoznam rozsahu",
    "list of providers" : "zoznam poskytovateľov",
    "Scope list metadata" : "Metadáta zoznamu rozsahu",
    "Required to nicely render the scope list in assistant" : "Vyžaduje sa pekné zobrazenie zoznamu rozsahu v asistentovi.",
    "Max result number" : "Maximálny počet výsledkov",
    "Maximum number of results returned by Context Chat" : "Maximálny počet výsledkov vrátených Context Chat",
    "Sources" : "Zdroje",
    "The sources that were found" : "Zdroje, ktoré boli nájdené",
    "Context Chat" : "Kontextový čet",
    "Ask a question about your data." : "Opýtať sa otázku o vašich dátach.",
    "Ask a question about your documents, files and more" : "Opýtajte sa na vaše dokumenty, súbory a ďalšie.",
    "list of sources or providers" : "zoznam zdrojov alebo poskytovateľov",
    "Generated response" : "Vygenerovaná odpoveď",
    "The text generated by the model" : "Text vygenerovaný modelom",
    "The sources referenced to generate the above response" : "Zdroje použité na vytvorenie vyššie uvedenej odpovede",
