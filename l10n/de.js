OC.L10N.register(
    ...
    "Ask questions to Nextcloud Assistant about the content of your documents.\n\n\nSee [the Admin docs](https://docs.nextcloud.com/server/latest/admin_manual/ai/app_context_chat.html) for installation steps and requirements.\n\nSetup background job workers as described here: https://docs.nextcloud.com/server/latest/admin_manual/ai/overview.html#improve-ai-task-pickup-speed\n\nNote:\nRefer to the [Context Chat Backend's readme](https://github.com/nextcloud/context_chat_backend/?tab=readme-ov-file) and the [AppAPI's documentation](https://cloud-py-api.github.io/app_api/) for help with setup of AppAPI's deploy daemon." : "Dem Nextcloud Assistant Fragen zum Inhalt deiner Dokumente stellen.\n\n\nInstallationsschritte und Anforderungen findest du in [den Administrations-Dokumenten] (https://docs.nextcloud.com/server/latest/admin_manual/ai/app_context_chat.html).\n\nRichte Hintergrund-Worker, wie hier beschrieben, ein: https://docs.nextcloud.com/server/latest/admin_manual/ai/overview.html#improve-ai-task-pickup-speed\n\nHinweis:\nHilfe zum Einrichten des Deploy-Daemons von AppAPI findet sich in der Readme-Datei [Context Chat Backend](https://github.com/nextcloud/context_chat_backend/?tab=readme-ov-file) und in der Dokumentation [AppAPI](https://cloud-py-api.github.io/app_api/).",
    "never" : "nie",
    "{time} ago" : "{time} her",
